...
css    = -> exec "stylus -u bootstrap-styl -o #{DIST}/css -m  #{SRC}/css/application.styl"
...
watch.css      = -> appcache().then -> exec "stylus -u bootstrap-styl -w -o #{DIST}/css -m  #{SRC}/css/application.styl"
watch.js       = -> appcache().then -> exec "coffee -w -o #{DIST}/js -cm #{SRC}/js/*.coffee"
